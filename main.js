...
axios.get('https://crudcrud.com/api/13865694742049ffa2cdae710b3e23c6/data')
.then((res)=>{
    console.log(res)
...
function store(e){
    ...
    axios.post('https://crudcrud.com/api/13865694742049ffa2cdae710b3e23c6/data',obj)
    .then((res)=>{
        console.log(res)
        showOnScreen(obj)
    })
...
function showOnScreen(obj){
    ...
    function remove(e){
        if(e.target.value='delete'){
            ...
            axios.delete(`https://crudcrud.com/api/13865694742049ffa2cdae710b3e23c6/data/${obj._id}`)
            .then((res)=>{
                console.log(res)
